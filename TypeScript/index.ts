 ...
 * with the associated class, Triangle
 * By:             Mr Coxall
 * Modifications:  Sam Corbett
 * Version:        1.0
 * Since:          2024/11/12
 */
...
console.log(' → Semiperimeter: ' +
  testTriangle1.semiPerimeter().toFixed(4) + ' mm')
...
console.log(' → Inner circle radius: ' +
  testTriangle1.innerCircleRadius().toFixed(4) + ' mm')
console.log(' → Circumcircle radius: ' +
  testTriangle1.circumsicleRadius().toFixed(4) + ' mm')
console.log('')
...
console.log(' → Semiperimeter: ' +
  testTriangle2.semiPerimeter().toFixed(4) + ' mm')
...
console.log(' → Inner circle radius: ' +
  testTriangle2.innerCircleRadius().toFixed(4) + ' mm')
console.log(' → Circumcircle radius: ' +
  testTriangle2.circumsicleRadius().toFixed(4) + ' mm')
console.log('')
...
console.log(' → Semiperimeter: ' +
  testTriangle3.semiPerimeter().toFixed(4) + ' mm')
...
console.log(' → Inner circle radius: ' +
  testTriangle3.innerCircleRadius().toFixed(4) + ' mm')
console.log(' → Circumcircle radius: ' +
  testTriangle3.circumsicleRadius().toFixed(4) + ' mm')
console.log('')
...
console.log(' → Semiperimeter: ' +
  testTriangle4.semiPerimeter().toFixed(4) + ' mm')
...
console.log(' → Inner circle radius: ' +
  testTriangle4.innerCircleRadius().toFixed(4) + ' mm')
console.log(' → Circumcircle radius: ' +
  testTriangle4.circumsicleRadius().toFixed(4) + ' mm')
console.log('')
...
console.log(' → Semiperimeter: ' +
  testTriangle5.semiPerimeter().toFixed(4) + ' mm')
...
console.log(' → Inner circle radius: ' +
  testTriangle5.innerCircleRadius().toFixed(4) + ' mm')
console.log(' → Circumcircle radius: ' +
  testTriangle5.circumsicleRadius().toFixed(4) + ' mm')
console.log('')
